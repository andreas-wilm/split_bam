...
# default run
#
bed=tests/test_input_1_a.refs.bed
cmd="$bin -l $bed -o $op $ib"
...
echo "Checking number of output reads";# (in $obams)
...
cmd="samtools view -h $ib | $bin -l $bed -b -o $op -"
